...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 967.28977382183075, 345.794411897659302, 103.0, 24.0 ],
					"text" : "r ---paramlocks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.666672259569168, 161.000003010034561, 64.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 119.000003546476364, 17.000000506639481, 42.0, 12.0 ],
					"text" : "ACC.OFFSET"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.666672259569168, 146.000003010034561, 64.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.666669428348541, 17.000000506639481, 35.0, 12.0 ],
					"text" : "ACCENTS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.666672259569168, 131.000003010034561, 76.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 61.0, 17.000000506639481, 33.0, 13.0 ],
					"text" : "OFFSET"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.666672259569168, 116.000003010034561, 80.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.500000923871994, 17.000000506639481, 30.0, 13.0 ],
					"text" : "BEATS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.666672259569168, 101.000003010034561, 79.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.666666716337204, 17.000000506639481, 28.0, 13.0 ],
					"text" : "STEPS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 724.5, 45.0, 29.5, 24.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 45.0, 29.5, 24.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 91.0, 185.0, 24.0 ],
					"text" : "sprintf symout CHANNEL %i"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -0.333333343267441, 1.000000029802322, 15.0, 16.75 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 958.0, 537.777803421020508, 89.0, 24.0 ],
					"text" : "prepend lock"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 965.5, 417.757032752037048, 89.0, 75.0 ],
					"pictures" : [ "unlocked.svg", "locked.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ -1.000000029802322, 58.000001728534698, 12.0, 17.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 652.0, 162.0, 66.0, 24.0 ],
					"text" : "texton $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 745.0, 162.0, 51.0, 24.0 ],
					"text" : "text $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 546.320000000000164, 28.915663719177246, 76.0, 24.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 833.088219404220581, 399.5, 121.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.84033614397049, 0.84033614397049, 155.84033614397049, 17.000000506639481 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 935.0, 77.0, 150.0, 194.0 ],
					"text" : "\tSTEPS \t\t: 0,\n\tBEATS \t\t: 1,\n\tOFFSET \t\t: 2,\n\tACCENTS\t\t: 3,\n\tACC_OFFSET\t: 4,\n\tPITCH\t\t: 5,\n\tLENGTH\t\t: 6,\n\tVELOCITY\t: 7,\n\tACC_VELOCITY: 8,\n\tREVERSE\t\t: 9,\n\tLOCK\t\t:10,\nACTIVE\t\t:11"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 178.0, 394.0, 43.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.000001847743988, 27.000000804662704, 31.0, 31.0 ],
					"varname" : "offset1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -0.333333343267441, 58.000001728534698, 62.333335191011429, 17.000000506639481 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 680.0, 400.0, 19.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.666664928197861, 60.500001981854439, 58.333335071802139, 12.0 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 638.0, 400.0, 22.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.000001788139343, 60.666668474674225, 39.000001162290573, 12.0 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 267.0, 394.5, 42.0, 39.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 124.000003695487976, 27.000000804662704, 31.0, 31.0 ],
					"varname" : "offset1[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 223.0, 394.0, 42.0, 41.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 93.000002771615982, 27.000000804662704, 31.0, 31.0 ],
					"varname" : "offset1[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.333333343267441, 90.0, 154.333333313465118, 15.0 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 93.0, 394.0, 40.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 27.000000804662704, 31.0, 31.0 ],
					"varname" : "live.dial[8]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 134.0, 394.0, 42.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.000000923871994, 27.000000804662704, 31.0, 31.0 ],
					"varname" : "beats1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 531.0, 399.0, 74.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 77.000002235174179, 155.0, 12.0 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.5, 118.75, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-49::obj-10" : [ "live.text[13]", "live.text", 0 ],
			"obj-49::obj-22" : [ "live.numbox", "live.numbox", 0 ],
			"obj-5" : [ "live.text", "live.text", 0 ],
			"obj-59::obj-10" : [ "live.text[20]", "live.text", 0 ],
			"obj-59::obj-22" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-60::obj-10" : [ "live.text[14]", "live.text", 0 ],
			"obj-60::obj-22" : [ "live.numbox[4]", "live.numbox", 0 ],
			"obj-64" : [ "Trig Note 1[7]", "Trig Note 1", 0 ],
			"obj-72::obj-10" : [ "live.text[18]", "live.text", 0 ],
			"obj-72::obj-22" : [ "live.numbox[5]", "live.numbox", 0 ],
			"obj-76::obj-10" : [ "live.text[21]", "live.text", 0 ],
			"obj-76::obj-22" : [ "live.numbox[6]", "live.numbox", 0 ],
